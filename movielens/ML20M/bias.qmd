...
ax.scatter(temporal_runs['params.user_damping'], temporal_runs['params.item_damping'], temporal_runs['metrics.RMSE'])
...
pd.concat({
    ...
    'Random': temporal_runs.nsmallest(1, 'metrics.RMSE')[['params.user_damping', 'params.item_damping', 'metrics.RMSE']],
