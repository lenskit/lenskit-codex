...
pd.concat({
    ...
    'Random': random_runs.nsmallest(1, 'metrics.RMSE')[['params.user_damping', 'params.item_damping', 'metrics.RBP', 'metrics.RMSE']],
...
pd.concat({
    ...
    'Random': random_runs.nlargest(1, 'metrics.RBP')[['params.user_damping', 'params.item_damping', 'metrics.RBP', 'metrics.RMSE']],
}, names=['Method']).reset_index(-1, drop=True)
```
