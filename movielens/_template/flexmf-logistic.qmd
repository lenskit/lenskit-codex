---
title: FlexMF Logistic on ML1M
abstract-title: FlexMF Logistic
toc-title: FlexMF Logistic
echo: false
deps:
...
```{python}
runs = load_sweep_runs('flexmf-logistic', method='hyperopt')
iters = load_sweep_iters('flexmf-logistic', method='hyperopt')
result = load_sweep_result('flexmf-logistic', method='hyperopt')
