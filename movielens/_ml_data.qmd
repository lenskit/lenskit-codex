...
(
    ...
    + pn.geom_step(stat='ecdf', color=dft_line)
    + pn.scale_x_symlog()
    + pn.xlab('# of Ratings')
...
(
    ...
    + pn.geom_histogram(bins=25, fill=dft_fill)
    + pn.xlab('Mean Rating')
    + pn.ylab('# of Movies')
)
```
...
(
    ...
    + pn.geom_histogram(bins=50, fill=dft_fill)
    + pn.xlab('Mean Rating')
    + pn.ylab('# of Users')
...
(
    ...
    + pn.geom_histogram(bins=100, fill=dft_fill)
    + pn.xlab('# of Ratings')
    + pn.ylab('# of Users')
    + pn.scale_x_log10()
