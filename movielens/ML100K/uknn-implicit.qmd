---
title: Implicit User KNN on ML100K
echo: false
deps:
- sweeps/random/uknn-implicit-random
---

This page analyzes the hyperparameter tuning results for the User KNN
...
```{python}
runs = load_sweep_runs('uknn-implicit')
result = load_sweep_result('uknn-implicit')
...
```{python}
from codex.models.uknn_implicit import SEARCH_SPACE
