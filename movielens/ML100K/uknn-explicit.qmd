---
title: Explicit User KNN on ML100K
echo: false
deps:
...
```{python}
runs = load_sweep_runs('uknn-explicit')
result = load_sweep_result('uknn-explicit')
...
```{python}
from codex.models.uknn_explicit import SEARCH_SPACE
