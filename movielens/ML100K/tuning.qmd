...
pagetitle: ML100K Tuning Analysis
order: 4
jupyter: python3
deps:
- sweeps/random/
...
These charts display the maximum performance so far as the search progresses
through its trials. The vertical lines are at 30 and 60 trials.
...
plot = (
    ...
    + pn.geom_vline(xintercept=30, color='grey', linetype='dotted')
)
if n_trials >= 55:
