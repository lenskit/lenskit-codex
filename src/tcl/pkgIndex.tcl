...
package ifneeded models 0.1 [list source [file join $dir pipeline/models.tcl]]
...
package ifneeded parse 0.1 [list source [file join $dir pipeline/parse.tcl]]
package ifneeded path 0.1 [list source [file join $dir pipeline/path.tcl]]
package ifneeded runs 0.1 [list source [file join $dir pipeline/runs.tcl]]
